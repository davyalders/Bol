...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH1" Runat="Server">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="tbProductNaam"></asp:RequiredFieldValidator>
    <br />
    <asp:Label ID="lbPrijs" runat="server" Text="Prijs"></asp:Label>
    <asp:TextBox ID="tbPrijs" runat="server" Width="174px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="tbPrijs"></asp:RequiredFieldValidator>
    <br />
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="tbBeschrijving"></asp:RequiredFieldValidator>
    <br />
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="tbGewicht"></asp:RequiredFieldValidator>
    <br />
    <asp:Label ID="lbCategorie" runat="server" Text="Categorie"></asp:Label>
        <asp:DropDownList ID="DropDownList1" runat="server" Width="174px">
        </asp:DropDownList>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="DropDownList1"></asp:RequiredFieldValidator>
